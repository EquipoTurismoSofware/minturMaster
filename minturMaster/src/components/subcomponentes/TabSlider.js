      ...
      <div className="tabs">
        ...
        <div class="content">
          <section  className="contenido">
            <h2 className="contenido">Features</h2>Lorem ipsum dolor sit amet, consectetur adipisicing
          ...
          <section>
            <h2 className="contenido">Delivery Contents</h2>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Autem quas
            adipisci a accusantium eius ut voluptatibus ad impedit nulla, ipsa
            qui. Quasi temporibus eos commodi aliquid impedit amet, similique
            nulla.
          </section>
          <section>
            <h2>Shipping</h2>
