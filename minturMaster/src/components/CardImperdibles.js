...
class CardImperdibles extends Component {
  constructor(props) {
    ...
    swapCards(direction) {
        const currentCardEl = this.state.cardsContainerEl.current.querySelector(".current--card");
        const previousCardEl = this.state.cardsContainerEl.current.querySelector(".previous--card");
        const nextCardEl = this.state.cardsContainerEl.current.querySelector(".next--card");

        const currentBgImageEl = this.state.appBgContainerEl.current.querySelector(".current--image");
        const previousBgImageEl = this.state.appBgContainerEl.current.querySelector(".previous--image");
        const nextBgImageEl = this.state.appBgContainerEl.current.querySelector(".next--image");
    ...
    changeInfo(direction) {
        let currentInfoEl = this.state.cardInfosContainerEl.current.querySelector(".current--info");
        let previousInfoEl = this.state.cardInfosContainerEl.current.querySelector(".previous--info");
        let nextInfoEl = this.state.cardInfosContainerEl.current.querySelector(".next--info");
        let self = this;
    ...
    updateCard(e) {
        ...
        const currentInfoEl = this.state.cardInfosContainerEl.current.querySelector(".current--info");
    ...
    init() {
        ...
        tl.to(this.state.cardsContainerEl.current.children, {
            ...
            .to(this.state.cardInfosContainerEl.current.querySelector(".current--info").querySelectorAll(".text"), {
            delay: 0.5,
            duration: 0.4,
            stagger: 0.1,
            opacity: 1,
    ...
    waitForImages() {
        ...
        gsap.set(this.state.cardInfosContainerEl.current.querySelector(".current--info").querySelectorAll(".text"), {
            translateY: "40px",
            opacity: 0,
        });
        gsap.set([this.state.buttons.prev.current, this.state.buttons.next.current], {
            pointerEvents: "none",
            opacity: "0",
        });
		...
		return(
            <React.Fragment>
                ...
                <div class="app" ref={this.state.app}>
                    <div class="cardList">
                        <button class="cardList__btn btn btn--left" ref={this.state.buttons.prev} onClick={() => this.swapCards("left") }>
                            <div class="icon">
                        ...
                        <button class="cardList__btn btn btn--right" ref={this.state.buttons.next} onClick={() => this.swapCards("right")}>
                            <div class="icon">
                                <svg>
